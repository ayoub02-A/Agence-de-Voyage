				...
				<div class="gtco-container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
							<h2 class="cursive-font primary-color">All Our Type of Trips</h2>
					...
					<c:forEach var="e" items="${TypeVoyage}">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								<a
									href="AllVoyageTypeVoyage?IdType=${e.getId_typev()}"
									class="fh5co-card-item ">

									<div class="fh5co-text">
										<p class="cursive-font">Type de Voyage</p>
										<h2>${e.getNom_typev()}</h2>
