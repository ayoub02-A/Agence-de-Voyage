				...
				<div class="gtco-container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
							<h2 class="cursive-font primary-color">Your Personnal Data </h2>
							...
							<div class="">
								<a class="fh5co-card-item ">
									...
									<div class="form-group row">
											...
											<div class="col-sm-9">
												<input disabled="disabled" type="text" name="nom" class="form-control" value=${e.getNom_client() }>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input disabled="disabled" type="text" name="prenom" class="form-control" value=${e.getPrenom_client() }><small
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input disabled="disabled" type="email" name="email" class="form-control" value=${e.getEmail_client()} ><small
													class="help-block-none"></small>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input disabled="disabled" type="tel" name="tel" class="form-control" value=${e.getTel_client() }>
											</div>
										</div>
				...
				<c:forEach var="e" items="${Voyage}">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								<a href="AllDetailsTripapresRejoin?Id_Voyage=${e.getId_voyage()}"
