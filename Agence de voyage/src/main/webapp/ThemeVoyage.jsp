		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">All Our Theme Trips</h2>
					
				</div>
			</div>
			<c:forEach var="e" items="${ThemeVoyage}">
			<div class="row">

				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="AllVoyageTheme?IdTheme=${e.getId_vtheme()}" class="fh5co-card-item ">
						
						<div class="fh5co-text">
										<p class="cursive-font">Theme Trip</p>
										<h2 >${e.getNom_theme()}</h2>
