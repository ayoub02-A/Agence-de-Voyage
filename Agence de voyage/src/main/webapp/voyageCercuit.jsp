						...
						<div class="col-md-12 col-sm-12 ">
							...
							<div class="page-title">
								<div class="title_left">
									<h3>
										Gestion <small>Voyage courants</small>
									</h3>
								</div>
							...
							<div class="x_panel">
									...
									<a href="pdfVoyageCercuit" class="btn btn-secondary btn-xs"><i
								...
								<div class="title_left">
									<h3>
										Gestion <small>Voyage expirés</small>
									</h3>
								</div>
							</div>
									...
									<div class="x_content">
										...
										<table class="table table-striped projects">
											...
											<tbody>
												...
												<c:forEach items="${lvoyageex}" var="lvoyageex">
												<c:set var="count" value="${count + 1}" scope="page"/>
													<tr>
														<td>${count}</td>
														<td>${lvoyageex.nom_voyage}</td>
														<td>${lvoyageex.getDestination()}</td>
														<td>${lvoyageex.getDate_depart()}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
