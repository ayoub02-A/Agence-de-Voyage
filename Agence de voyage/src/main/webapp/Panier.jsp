					...
					<c:forEach var="e" items="${Voyage}">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								<a href="AllDetailsTripPanier?Id_Voyage=${e.getId_voyage()}"
						...
						<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
							<div class="form-group row">
										<div class="col-sm-9 ml-auto">
													 <a href="supprimerVPanier?Id_Voyage=${e.getId_voyage() }"><i class="btn btn-primary">Supprimer Voyage Du Panier</i> </a>
										</div>
									</div>
